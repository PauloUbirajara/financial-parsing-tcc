<script lang="ts">
  ...
  let formMessages: LoginFormMessages = { success: "", errors: {} };
  let credentials = {
    username: "",
    password: "",
  };
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      formMessages = loginResponse.data;
...
<form class="p-4" on:submit|preventDefault={handleSubmit}>
  ...
  <div class="flex flex-col gap-5">
    ...
    <A
      ...
      class="text-custom-primary font-bold text-sm">Esqueceu sua senha?</A
    >
  </div>
